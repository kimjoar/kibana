...
/**
 *  If the input Observable is already a native observable it
 *  is returned, otherwise a new Observable is created that
 *  will mirror the input by calling it's subscribe() function.
